...
capscontentguid: 742877bf-26f5-40e3-b1f7-8475e7c3ce11
---
# Terminology for Azure Rights Management
Confused by a word, phrase, or acronym that’s related to Microsoft [!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)] (Azure RMS)? Find the definition here for terms and abbreviations that are either specific to Azure RMS or have a specific meaning when used in the context of [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)].

|Term <br /> <br />|Definition <br /> <br />|
|--------|--------------|
|AADRM <br /> <br />|The name of the Windows PowerShell module for Azure Rights Management, which was derived from the unofficial abbreviation for [!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)] when it was previously named (Windows) Azure Active Directory Rights Management. <br /> <br />|
|activate <br /> <br />|To enable the [!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)] service so that an organization can add information protection to their documents and email. This action also enables Rights Management features in Exchange Online and SharePoint Online. <br /> <br />|
...
|bring your own key <br /> <br />|Frequently abbreviated to *BYOK*. <br /> <br />A configuration option chosen by an organization that wants to generate and manage their own tenant key for [!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)]. <br /> <br />|
|content key <br /> <br />|A unique key that is created by RMS-enlightened applications for each document or email that is protected by using [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)] and that helps to limit the risk of information disclosure. <br /> <br />|
|consume <br /> <br />|To unlock a file to read or use it when that file has been protected by [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)]. <br /> <br />|
|deactivate <br /> <br />|To disable the Rights Management service so that the organization can no longer use [!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)]. <br /> <br />|
...
|generic protection <br /> <br />|A level of protection that encrypts any file type and prevents unauthorized people from opening the file. After the file is opened, the file is now unencrypted and usable in an application that doesn’t natively support [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)]. <br /> <br />|
...
|Rights Management services <br /> <br />|The generic term that applies to both the cloud version of [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)] ([!INC[aad_rightsmanagement_1](../Token/aad_rightsmanagement_1_md.md)]) and the on-premises version of [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)] (AD RMS). <br /> <br />|
...
|RMS for individuals <br /> <br />|A free subscription for a user to use [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)] when their organization does not have a subscription to Office 365 or Azure Active Directory. <br /> <br />|
...
|tenant key <br /> <br />|Also known as the server licensor certificate (SLC) key. <br /> <br />The key that is unique to an organization and ultimately secures all [!INC[aad_rightsmanagement_2](../Token/aad_rightsmanagement_2_md.md)] cryptographic functions that chain to this tenant key. <br /> <br />|
